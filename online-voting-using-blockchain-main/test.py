...
class Block():
    ...
    def calcHash(self):
        block_string = json.dumps(
            {"Chain Nonce": self.nonce, "VotinggTimestamp": str(self.tstamp), "voterInfo": self.voterInfo,
             "previoushash": self.previoushash}, sort_keys=True).encode()
